        ...
        <div className="flex flex-col items-center text-center">
            ...
            {showBriefing && (
                <div className="mt-5 w-full text-left">
                    ...
                    <pre className="whitespace-pre-wrap rounded-2xl bg-gray-100 border border-gray-300 dark:bg-ink-900 dark:border-ink-700/60 p-4 text-xs leading-relaxed text-gray-700 dark:text-gray-300 max-h-56 overflow-y-auto">{persona.system_prompt}</pre>
                </div>
            )}
            {canEdit && (
        ...
        <Modal title={detailPersona ? detailPersona.name : "The roaster"} setShowModal={setShowModal} isLoading={isLoading}>
            {detailPersona ? (
                ...
                <>
                    ...
                    <div className="rounded-xl bg-gray-100 border border-gray-300 dark:bg-ink-900 dark:border-ink-700/60 px-3 py-2 text-xs text-gray-600 dark:text-gray-400">
