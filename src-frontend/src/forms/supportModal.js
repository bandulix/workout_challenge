...
function AccordionMenu() {
    const items = [
        ...
        {title: "Credits", content: "Fork of <a class='text-blue-500 hover:underline' target='_blank' href='https://github.com/vanalmsick/workout_challenge'>vanalmsick/workout_challenge</a> under the SSPL v1.0 license - see <a class='text-blue-500 hover:underline' target='_blank' href='https://github.com/bandulix/workout_challenge'>github.com/bandulix/workout_challenge</a>. See <a class='text-blue-500 hover:underline' target='_blank' href='/credits.txt'>here for stock image credits</a>."},
    ];
        ...
        <div className="max-w-xl mx-auto divide-y divide-gray-300">
            ...
            <div className="border-b py-4">
                <div align="center" className="text-sm text-gray-600 dark:text-gray-400 space-y-1">
                    <p><b>Workout Challenge</b> — fork of <a className="text-blue-500 hover:underline" target="_blank" href="https://github.com/vanalmsick/workout_challenge">vanalmsick/workout_challenge</a></p>
                    <p>Original work © 2025 <a className="text-blue-500 hover:underline" target="_blank" href="https://github.com/vanalmsick">github.com/vanalmsick</a><br/>
                    Fork modifications © 2026 <a className="text-blue-500 hover:underline" target="_blank" href="https://github.com/bandulix/workout_challenge">bandulix</a></p>
                    <p className="text-xs">Licensed under the <a className="text-blue-500 hover:underline" target="_blank" href="https://github.com/bandulix/workout_challenge/blob/main/LICENSE">Server Side Public License v1 (SSPL)</a></p>
                </div>
            </div>
        </div>
    );
