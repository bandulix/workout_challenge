...
def sync_strava(self, user__id, start_datetime=None):
    ...
    # Stamp after every successful sync, including the initial 43-day
    # backfill (start_datetime set). Skipping that path left the throttle
    # field NULL so bookkeeping stayed stale (#24).
