    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('award', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='competition.award')),
                ('goal', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='competition.activitygoal')),
            ],
            options={
                'verbose_name': 'Points',
